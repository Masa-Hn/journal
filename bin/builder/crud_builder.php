    ...
    foreach ($table_desc as $key => $field_desc) {
        ...
        if ($field_desc['Field'] !== 'id') {
            ...
            <div class="form-group">
                <label class="control-label col-md-3"><?php echo $ucwords_field?></label>
                <div class="col-md-9">
...
$fields_4 .= <<<CODE4
            <div>
                <label class="control-label"><?php echo $ucwords_field?> : </label>
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <span class="panel-title"><?php echo $ucwords_name ; ?></span>
        </div>
        <div class="modal-body">

            <div class="form-group">
                <button class="btn btn-labeled btn-success btn-block" onclick="add_more_{$name}();" type="button"><span class="btn-label"><i class="fa fa-plus"></i></span><?php echo 'Add {$ucwords_name}'; ?></button>
            </div>
                        ...
                        <tr class="item">
                            ...
                            <td class="col-md-2 valign-middle text-center">
                                ...
                                <button type="button" class="btn btn-labeled btn-danger" onclick="remove_option(this);" >
                                    <i class="fa fa-trash-o btn-label"></i><?php echo 'Delete'; ?>
                                </button>
                            </td>
                        </tr>
                    <?php } ?>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-sm btn-danger pull-left btn-labeled" data-dismiss="modal"><span class="btn-label"><i class="fa fa-times"></i></span><?php echo 'close'; ?></button>
            <button type="submit" class="btn btn-sm btn-primary pull-right btn-labeled" <?php echo data_loading_text() ?>><span class="btn-label"><i class="fa fa-floppy-o"></i></span><?php echo 'save'; ?></button>
        </div>
        <?php echo form_close(); ?>
    </div>
</div>
...
<div class="note note-info clearfix">
    <div class="pull-left">
        <b><?php echo ' $ucwords_name. s'?></b>
    </div>
    <?php if(\$user_id == Orm_User::get_logged_user_id()) { ?>
        <div class="pull-right">
            <a href="/faculty_portfolio/publication/{$name}_manage" data-toggle="ajaxModal" class="btn btn-primary btn-sm btn-labeled"><i class="btn-label fa fa-edit"></i><?php echo 'Edit' ?></a>
        </div>
    <?php } ?>
</div>
