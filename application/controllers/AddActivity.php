...
class AddActivity extends CI_Controller {
  ...
  public function index()
  {
    ...
    $data['allActivities']=$this->ActivitiesModel->getAllActivities();
  ...
  public function add_activity()
  {
    ...
    if (! empty($_POST["new_activity_name"])) {
      $a=$this->input->post('new_activity_name');
    }//if
    else{
